...
export default function TomorrowsIntentionsScreen() {
  ...
  const sunsetPulse = useRef(new Animated.Value(1)).current;
  ...
  }, [fadeAnim, slideAnim, sunsetPulse, starsRotate, sparkleOpacity, glitterParticles]);
  ...
  const handleAddEntry = () => {
    if (newEntry.trim()) {
      ...
      setIntentionEntries([entry, ...intentionEntries]);
      setNewEntry("");
      setIsAdding(false);
    }
  };
  ...
  const handleDeleteEntry = (id: string) => {
    ...
    setIntentionEntries(intentionEntries.filter((entry) => entry.id !== id));
  };
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.7}
        >
          <ArrowLeft color="#e8a8c5" size={28} strokeWidth={2.5} />
        </TouchableOpacity>
        ...
        <View style={styles.safeArea}>
          ...
          >
            <View style={styles.headerContent}>
              <View style={styles.headerLeft}>
                <Animated.View style={{ transform: [{ scale: sunsetPulse }] }}>
                  <Sunset
                    color="#e8a8c5"
                    size={48}
                    strokeWidth={2}
          ...
          >
            ...
            <View style={styles.entriesContainer}>
              {intentionEntries.map((entry, index) => (
              ...
              {intentionEntries.length === 0 && !isAdding && (
...
const styles = StyleSheet.create({
  ...
  quoteCard: {
    ...
    borderWidth: 1,
    borderColor: "rgba(232, 168, 197, 0.2)",
  },
  quoteOverlay: {
    padding: 24,
  },
  ...
  entryCard: {
    ...
    backgroundColor: "rgba(255, 255, 255, 0.05)",
    borderWidth: 1,
    borderColor: "rgba(232, 168, 197, 0.15)",
  },
  entryCardInner: {
    padding: 20,
  },
  ...
  backButton: {
    ...
    justifyContent: "center",
    borderRadius: 22,
    backgroundColor: "rgba(232, 168, 197, 0.15)",
  },
  glitterDot: {
    position: "absolute" as const,
