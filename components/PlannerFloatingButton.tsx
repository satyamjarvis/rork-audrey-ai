...
export default function PlannerFloatingButton() {
  ...
  useEffect(() => {
    if (!hasLoadedPosition.current) {
      ...
      getButtonPosition('planner', isUniversePage).then(position => {
  ...
  useEffect(() => {
    if (pathname === '/universe' && universeMode === 'universe') {
      ...
      getButtonPosition('planner', isUniversePage).then(savedPos => {
  ...
  const handlePress = () => {
    if (pathname === '/planner' || pathname.includes('/(tabs)/planner')) {
      return;
    }
    ...
    PanResponder.create({
      ...
      onPanResponderRelease: (_, gestureState) => {
        ...
        Animated.spring(pan, {
          ...
          const isUniversePage = pathname === '/universe';
          saveButtonPosition('planner', { x: boundedX, y: boundedY }, isUniversePage);
        });
