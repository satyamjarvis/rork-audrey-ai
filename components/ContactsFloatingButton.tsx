...
export default function ContactsFloatingButton() {
  ...
  useEffect(() => {
    if (!hasLoadedPosition.current) {
      ...
      getButtonPosition('contacts', isUniversePage).then(position => {
  ...
  useEffect(() => {
    if (pathname === '/universe' && universeMode === 'universe') {
      ...
      getButtonPosition('contacts', isUniversePage).then(savedPos => {
  ...
  const handlePress = () => {
    if (pathname === '/phonebook' || pathname.includes('/(tabs)/phonebook')) {
      return;
    }
    ...
    PanResponder.create({
      ...
      onPanResponderRelease: (_, gestureState) => {
        ...
        Animated.spring(pan, {
          ...
          const isUniversePage = pathname === '/universe';
          saveButtonPosition('contacts', { x: boundedX, y: boundedY }, isUniversePage);
        });
