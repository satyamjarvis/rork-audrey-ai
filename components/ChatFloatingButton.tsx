...
export default function ChatFloatingButton() {
  ...
  useEffect(() => {
    if (!hasLoadedPosition.current) {
      ...
      getButtonPosition('chat', isUniversePage).then(position => {
  ...
  useEffect(() => {
    if (pathname === '/universe' && universeMode === 'universe') {
      ...
      getButtonPosition('chat', isUniversePage).then(savedPos => {
  ...
  const handlePress = () => {
    if (pathname === '/chats' || pathname.includes('/(tabs)/chats')) {
      return;
    }
    ...
    PanResponder.create({
      ...
      onPanResponderRelease: (_, gestureState) => {
        ...
        Animated.spring(pan, {
          ...
          const isUniversePage = pathname === '/universe';
          saveButtonPosition('chat', { x: boundedX, y: boundedY }, isUniversePage);
        });
