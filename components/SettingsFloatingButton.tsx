...
export default function SettingsFloatingButton() {
  ...
  useEffect(() => {
    if (!hasLoadedPosition.current) {
      ...
      getButtonPosition('settings', isUniversePage).then(position => {
  ...
  useEffect(() => {
    if (pathname === '/universe' && universeMode === 'universe') {
      ...
      getButtonPosition('settings', isUniversePage).then(savedPos => {
  ...
  const handlePress = () => {
    if (pathname === '/settings' || pathname.includes('/(tabs)/settings')) {
      return;
    }
    ...
    PanResponder.create({
      ...
      onPanResponderRelease: (_, gestureState) => {
        ...
        Animated.spring(pan, {
          ...
          const isUniversePage = pathname === '/universe';
          saveButtonPosition('settings', { x: boundedX, y: boundedY }, isUniversePage);
        });
