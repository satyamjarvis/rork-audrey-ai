...
export default function TrackFloatingButton() {
  ...
  useEffect(() => {
    if (!hasLoadedPosition.current) {
      ...
      getButtonPosition('track', isUniversePage).then(position => {
  ...
  useEffect(() => {
    if (pathname === '/universe' && universeMode === 'universe') {
      ...
      getButtonPosition('track', isUniversePage).then(savedPos => {
  ...
  const handlePress = () => {
    if (pathname === '/track' || pathname.includes('/(tabs)/track')) {
      return;
    }
    ...
    PanResponder.create({
      ...
      onPanResponderRelease: (_, gestureState) => {
        ...
        Animated.spring(pan, {
          ...
          const isUniversePage = pathname === '/universe';
          saveButtonPosition('track', { x: boundedX, y: boundedY }, isUniversePage);
        });
